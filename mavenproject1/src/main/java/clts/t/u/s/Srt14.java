...
public class Srt14 extends SuperTU
{
    public Srt14()
    {
        super();
    ...
    public Srt14(String middle)
    {
        super(middle);
        containsTL = true;
    }

    public Srt14(String middle, ColorArray colorSwitch)
    {
    ...
    public void drawLower(int x, int y, GraphicsMap g2d)
    {
        ...
        g2d.fillRect(110 + x, 66 + y, 1, 11);
        g2d.fillRect(104 + x, 67 + y, 1, 11);
        g2d.fillRect(115 + x, 68 + y, 1, 2);
        g2d.fillRect(116 + x, 69 + y, 1, 6);
        g2d.fillRect(103 + x, 74 + y, 1, 6);
        g2d.fillRect(111 + x, 74 + y, 1, 6);
