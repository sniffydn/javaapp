...
public class Srt9 extends SuperTU
{
    public Srt9()
    {
        super();
    ...
    public Srt9(String middle)
    {
        super(middle);
        containsTL = true;
    }

    public Srt9(String middle, ColorArray colorSwitch)
    {
